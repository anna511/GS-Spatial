...
#phi and matrices for prmse and pcor
  ...
  model1.Gr.pcor.2 <- model1.Gc.prmse.2 <- model1.Gc.pcor.2 <-  model1.Gc.fail.2 <- vector()
  ...
  model2.AR.prmse.2 <- model2.AR.pcor.2 <- model2.ARr.prmse.2 <- model2.ARr.prmse.2 <- model2.ARc.prmse.2 <- vector()
  model2.ARc.pcor.2 <- model2.AR.fail.2 <- model2.ARr.fail.2 <- model2.ARc.fail.2 <- vector()
...
model1.prmse.2 <- model2.prmse.2 <- model1.pcor.2 <- model2.pcor.2 <- model.prmse <- model.pcor <- model.fail <- NULL
  ...
  model1.pcor.2 <- cbind(model1.G.pcor.2, model1.Gr.pcor.2, model1.Gc.pcor.2, model1.S.pcor.2, 
                         model1.Sr.pcor.2, model1.Sc.pcor.2)                   
